...
namespace Front.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            var serviceProxy = ServiceProxy.Create<IStudentService>(new Uri("fabric:/BackendCloud/StudentServiceStatefull"),
        ...
        public IActionResult Izvestaj()
        {
            ...
            {
                workbook.AddWorksheet("Izvestaj").FirstCell().InsertTable<OcenaNaPredmetu>(i.ocene,false);
                workbook.SaveAs(@"C:\Users\Alen\Desktop\Izvestaj.xlsx"); 
            }
